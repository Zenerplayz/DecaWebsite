  ...
  return (
    <>
      ...
      <section className="border-y border-pine-100 bg-white/60">
        <div className="container-page grid grid-cols-1 gap-6 py-12 sm:grid-cols-3">
          {site.stats.map((s) => (
      ...
      <section className="bg-white py-20 sm:py-28">
        <div className="container-page text-center">
          ...
          <h2 className="mt-2 font-display text-3xl font-bold tracking-tight text-pine-950 sm:text-4xl">
            Never miss a meeting
          </h2>
          <p className="mx-auto mt-4 max-w-md text-pine-600">
            Meeting dates, deadlines, and competition days all live on the calendar.
          </p>
          <div className="mt-8">
